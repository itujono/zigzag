                ...
                <div class="item">
                    ...
                    <div class="content">
                        ...
                        <div class="extra">
                            ...
                            <button class="add_cart ui basic teal button" title="Tambahkan ke Cart" data-barangid="<?php echo $search->idBARANG;?>" data-barangnama="<?php echo $search->nameBARANG;?>" data-barangharga="<?php echo $search->priceBARANG;?>">
